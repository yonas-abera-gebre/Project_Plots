...
def File_Name_To_Data(file_name, X_lim = (-10,10,100), Y_lim = (-10,10,100), Z_lim = (-10,10,100)):
...
def PEM_Data_Plotter(PEM_data, X_lim = (-10,10,100), Y_lim = (-10,10,100), Z_lim = (-10,10,100)):
